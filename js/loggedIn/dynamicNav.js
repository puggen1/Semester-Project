...
if(!isLoggedIn){
   ...
   <li class="nav-item">
     <a class="nav-link d-flex align-items-center text-dark fs-4" href="./profile.html">Profile <div class="profileImage ratio"><img class="rounded-circle col-1"src="${avatar}"></div></a>
   </li>
   <li class="nav-item">
       <button id="navNewListing" type="button" class="btn btn-link text-decoration-none ms-0 ps-0 fs-4"><a href="./createlisting.html" class="text-dark text-decoration-none">New Listing</a></button>
   </li>
   <li class="nav-item">
       <a class="nav-link text-dark fs-4" href="./profile.html#myCollection">My collection</a>
     </li>
   <li class="nav-item">
